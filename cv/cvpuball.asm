...
if	fg_pe
		...
		EXTERNDEF	MOVE_TEXT_TO_OMF:PROC,HANDLE_CV_INDEX:PROC,FLUSH_CV_TEMP:PROC,STORE_CV_SYMBOL_INFO:PROC
		EXTERNDEF	OUTPUT_CV_SYMBOL_ALIGN:PROC,INIT_CV_SYMBOL_HASHES:PROC,FLUSH_CV_SYMBOL_HASHES:PROC,SAY_VERBOSE:PROC
...
STORE_THIS_PUBLIC	PROC	NEAR
		...
		JMP	STORE_CV_SYMBOL_INFO	;STORE INFO FOR SYMBOL HASHES
...
STORE_THIS_IMPORT	PROC	NEAR
		...
		MOV	CVG_SYMBOL_HASH,EAX
		CALL	STORE_CV_SYMBOL_INFO	;STORE INFO FOR SYMBOL HASHES
