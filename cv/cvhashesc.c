...
CVG_PUT_LIMIT		DD	?
CVG_PUT_BLK		DD	?
CV_SECTION_OFFSET	DD	?
CV_SECTION_HDR_ADDRESS	DD	?
CV_SYMBOL_BASE_ADDR	DD	?
CVG_N_HASHES		DD	?
CVG_BUFFER_LOG		DD	?
CVG_BUFFER_LIMIT	DD	?
FIRST_CVH		DD	?
...
CV_PRIMES		DW	1,3,7,0DH,1FH,2FH,3DH,4FH,59H,6DH,7FH,8BH,9DH,0ADH,0BFH,0C7H,0DFH,0EFH,0FBH
			DW	11BH,13DH,15DH,17FH,199H,1BBH,1DFH,1FDH
			DW	21DH,23BH,25FH,277H,295H,2BDH,2DDH,2F9H
			DW	31DH,33DH,35FH,377H,397H,3B9H,3DFH,3FDH
			DW	43FH,47FH,4BDH,4FFH
			DW	52FH,577H,5BFH,5FBH
			DW	63DH,67FH,6BBH,6FDH
			DW	737H,779H,7BBH,7F7H
			DW	83FH,871H,8BFH,8F9H
;			DW	935H,977H,9ADH,9FDH
;			DW	0A3DH,0A7FH,0ABDH,0AF3H
;			DW	0B3FH,0B7BH,0BB9H,0BFBH
;			DW	0C31H,0C77H,0CBBH,0CFBH
;			DW	0D3FH,0D79H,0DBDH,0DFFH
;			DW	0E3BH,0E7DH,0EB9H,0EF9H
;			DW	0F31H,0F7FH,0FBBH,0FFDH

CV_HASH_HEADER		CV_HASH_HDR_STRUCT	<10,12,0,0,0>
