/* unmangle.c Copyright (c) 1993 by Symantec
   ...
   People writing tools to interface with Symantec C++ are strongly
   encouraged to use this code.
   
   This file contains a number of functions which allow the un-mangling
   of C++ mangled names as used in Symantec C++. The primary function
...
static char __near *um_table[] = {
    ...
    "delete[]",
    "?_R",            // special operator=()
    /* NCEG operators that only Symantec implements    */
    "!<>=",        /* _S    */
    "<>",
    "<>=",
    "!>",
