		...
		PUBLIC	SET_CASE_MODE,IGNORECASE_PROC,NOIGNORECASE_PROC,MAPSTUFF,PATHSTUFF,NOCHECKSUM_PROC,NEST_INDIRECT
		PUBLIC	UPPERCASE_PROC,LOWERCASE_PROC,CHECKSUM_PROC,STORE_FILNAM,OBJSTUFF,LOCAL_INFO,NULSTUFF
