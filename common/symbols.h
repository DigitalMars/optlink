...
typedef struct SYMBOL_STRUCT
{
    ...
    #define _S_DEFINING_MOD	_S_MOD_GINDEX		// MODULE # IF DEFINED NORMALLY (USED DURING XREF OUTPUT)
    #define _COMM_MOD_GINDEX	_S_MOD_GINDEX
    ...
    #define _S_IMP_MODULE	_S_SEG_GINDEX		// IMPORT MODULE NUMBER (INDEX INTO NEXEHEADER) (AND IMPMOD_GARRAY)
    #define _COMM_SIZE_A	_S_SEG_GINDEX
