...
if	fg_td
		...
		EXTERNDEF	GET_RECORD:PROC,FORREF:PROC,FORREF32:PROC,CHECK_CHECKSUM:PROC
		...
		EXTERNDEF	TOO_LONG:PROC,SEGDEF32:PROC,GRPDEF:PROC,FIXUPP:PROC,FIXUPP32:PROC,LEDATA:PROC,LEDATA32:PROC
