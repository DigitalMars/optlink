...
$(LIB)\INSTALL.LIB : $(OBJ)\MODNAME.OBJ $(OBJ)\MODPAGE.OBJ $(OBJ)\FARINST.OBJ $(OBJ)\DEFCLASS.OBJ $(OBJ)\INSTOUT.OBJ $(OBJ)\PUTGROUP.OBJ $(OBJ)\SENTRYNM.OBJ $(OBJ)\FINSEGAT.OBJ $(OBJ)\SENTRY.OBJ $(OBJ)\INSTSOFT.OBJ $(OBJ)\INSTNMSP.OBJ \
			$(OBJ)\INSTFILE.OBJ $(OBJ)\SOFTPENT.OBJ $(OBJ)\NAMEINST.OBJ $(OBJ)\INSTCLAS.OBJ $(OBJ)\INSTSEG.OBJ $(OBJ)\ADDTOEXT.OBJ $(OBJ)\MYCOMDAT.OBJ $(OBJ)\MLTICSEG.OBJ $(OBJ)\INSTCOMM.OBJ $(OBJ)\INSTRELO.OBJ $(OBJ)\IENTRYNM.OBJ \
			$(OBJ)\INSTGRP.OBJ $(OBJ)\GETSEGMT.OBJ $(OBJ)\DSEGMOD.OBJ $(OBJ)\IENTRY.OBJ $(OBJ)\INSTIMPN.OBJ $(OBJ)\IRESNAME.OBJ $(OBJ)\INSTFLNM.OBJ $(OBJ)\SRCINST.OBJ $(OBJ)\IRESTYPE.OBJ \
			$(OBJ)\INSTPENT.OBJ $(OBJ)\FUZZINST.OBJ
  OPTLIB /OKMULTI $(LIB)\INSTALL ~+ $(OBJ)\*;
